...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ferns_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/team_nu/ROS/install/${idir}'.  Ask the maintainer 'Luka Čehovin <luka.cehovin@fri.uni-lj.si>' to fix it.")
    endif()
