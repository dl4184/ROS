...
if("FALSE" STREQUAL "TRUE")
  set(localizer_SOURCE_PREFIX /home/team_nu/ROS/src/localizer)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'localizer' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'team_nu <team_nu@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'localizer' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/team_nu/ROS/install/${idir}'.  Ask the maintainer 'team_nu <team_nu@todo.todo>' to fix it.")
    endif()
